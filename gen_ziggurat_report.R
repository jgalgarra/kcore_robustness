...
dir.create("plot_results/ziggurat/", showWarnings = FALSE)

peso = "log10"
# ziggurat_graph("data/","M_PL_001.csv",plotsdir = "plot_results/ziggurat",weirds_boxes_separation_count = 3,height_box_y_expand =1.5,
...
#
# ziggurat_graph("data/","M_PL_004.csv", height_box_y_expand =2,weighted_links = peso,
#                plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
...
#                 plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.3,
...
#                lsize_legend = 7, lsize_core_box = 6,corebox_border_size=1, weighted_links = peso,
#                plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,
#                print_to_file = TRUE)
...
#                plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,corebox_border_size=1,
...
ziggurat_graph("data/","M_PL_031.csv", aspect_ratio = 0.60, height_box_y_expand =3, displace_outside_component = c(-0.5,1),
               plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,factor_hop_x = 1.2,
               lsize_kcoremax = 6,lsize_zig = 4,lsize_kcore1 = 4.5,corebox_border_size=1,weighted_links = peso,
...
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                 lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_PL_038.csv", plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
...
# ziggurat_graph("data/","M_PL_050.csv", plotsdir = "plot_results/ziggurat",
...
#
#
# ziggurat_graph("data/","M_SD_001.csv", plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_002.csv", plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_003.csv",  plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_004.csv",  plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                displace_outside_component = c(-0.3,1),
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_005.csv",  plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_006.csv",  plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                displace_outside_component = c(-0.3,1),
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,-0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_007.csv",  plotsdir = "plot_results/ziggurat",
...
# ziggurat_graph("data/","M_SD_008.csv", plotsdir = "plot_results/ziggurat",color_link = "slategray3",
...
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_009.csv", height_box_y_expand = 1.5, plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,aspect_ratio = 1.5,
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_010.csv", coremax_triangle_width_factor = 1.3,  height_box_y_expand = 2,
#                plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 4.5,lsize_zig = 4,lsize_kcore1 = 5,corebox_border_size=0.5,
#                displace_y_a = c(0,0,0,0.2,0.2),
#                lsize_legend = 7, lsize_core_box = 4,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_011.csv",  plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_012.csv",  plotsdir = "plot_results/ziggurat",color_link = "slategray3", alpha_link = 0.5,
#                lsize_kcoremax = 6,lsize_zig = 5,lsize_kcore1 = 5,corebox_border_size=1,
#                lsize_legend = 7, lsize_core_box = 6,displace_legend = c(-0.2,0.2), print_to_file = TRUE)
...
#                lsize_core_box = 5, lsize_kcoremax = 4.4, lsize_zig = 4, lsize_kcore1 = 4, lsize_legend = 7,
#                print_to_file = TRUE)
# ziggurat_graph("data/","M_SD_022.csv", kcore2tail_vertical_separation = 4,plotsdir = "plot_results/ziggurat",
