# Algorithm to find the number of primary extinctions of any guild to destroy 
# half the giant component according to different indexes
#
# Invocation
#
# first_extinction_algorithm(serie =1, maxciclos = 100)
#
# Experiment must be run 100 times, but it is slow 
#
# To gain advantage of multicore you may divide the task in four (for instance) and call
#    first_extinction_algorithm(serie =1, maxciclos = 25)
#    first_extinction_algorithm(serie =26, maxciclos = 25)
#    first_extinction_algorithm(serie =51, maxciclos = 25)
#    first_extinction_algorithm(serie =76, maxciclos = 25)
#
# Results will be stored in extinctions/ directory
# Files are called ALL_EXTINCTIONS_halfGC_X  where X is the "serie" parameter
#
# Inside there is a subdirectory called published_data
...
first_extinction_algorithm <- function(serie=1, maxciclos =100)
{
